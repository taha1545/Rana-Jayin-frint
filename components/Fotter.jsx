        ...
        <footer className="bg-secondary dark:bg-gray-900">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                ...
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-4 mb-8">
                    {/* Pages */}
                    <div>
                        <h2 className="mb-6 text-sm font-semibold text-secondary-foreground uppercase">
                            {t('footer.pages')}
                        </h2>
                        <ul className="text-muted-foreground font-medium">
                            ...
                            <li className="mb-4">
                                <Link href="/map" className="hover:text-secondary-foreground transition-colors duration-200">
                                    {t('nav.map')}
                                </Link>
                            </li>
                            <li className="mb-4">
                            ...
                            <li>
                                <Link href="/auth/login" className="hover:text-secondary-foreground transition-colors duration-200">
                                    {t('nav.login')}
                                </Link>
                            </li>
                        </ul>
