            ...
            <div className="max-w-6xl mx-auto text-center">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    {services.map((service, index) => (
                        ...
                        >
                            <Card className="hover:shadow-xl dark:hover:shadow-blue-800 transition-all duration-300 h-full flex flex-col justify-between rounded-2xl border border-gray-200 dark:border-gray-700">
